...
import GUI_Classes.ClientServicesForm;
import GUI_Classes.ControlForm;
import java.sql.*;
import javax.swing.JOptionPane;


public class Client_LoginForm extends javax.swing.JFrame {

    
    public Client_LoginForm() {
        initComponents();
    }
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try {
            ...
            Con.close();
            ClientServicesForm p = new ClientServicesForm();
            p.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Client_LoginForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Client_LoginForm().setVisible(true);
            }
        });
    }
